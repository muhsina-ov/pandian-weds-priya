        ...
        {petals.map((p) => (
          <span
            ...
            style={{
              ...
              background:
                p.hue < 0.35
                  ? "radial-gradient(circle at 30% 30%, #ffd166, #e59500)"
                  : p.hue < 0.7
                    ? "radial-gradient(circle at 30% 30%, #ff758f, #c9184a)"
                    : "radial-gradient(circle at 30% 30%, #fffbf0, #f7d6a5)",
              borderRadius: "70% 30% 65% 35% / 60% 60% 40% 40%",
              boxShadow: "0 2px 6px rgba(0,0,0,0.18)",
              animation: `petal-fall ${2.0 + p.hue}s cubic-bezier(.3,.6,.4,1) forwards`,
