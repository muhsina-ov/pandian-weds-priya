    ...
    <PetalTap>
      <header className="relative min-h-[100svh] overflow-hidden paper">
        ...
        >
          ...
          <h1
            className="mt-3 font-display text-[2.8rem] sm:text-[3.2rem] leading-[1.05] text-foreground animate-ink font-semibold"
            style={{ animationDelay: "0.7s" }}
          >
            {couple.groomShort}
            <span className="script mx-2 block text-2xl text-primary font-normal">&amp;</span>
            {couple.brideShort}
          </h1>
          <p
            className="mt-5 text-[0.66rem] uppercase tracking-airy text-muted-foreground animate-ink font-medium"
            style={{ animationDelay: "1s" }}
          >
            {couple.weddingDateLabel}
          </p>
          <p
            className="mt-2 text-[0.66rem] uppercase tracking-airy text-muted-foreground animate-ink font-medium"
            style={{ animationDelay: "1.15s" }}
          >
            Pasuvanthanai · Tamil Nadu
          </p>
        </div>
      </header>
    </PetalTap>
